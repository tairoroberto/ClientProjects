<div class="header navbar navbar-inverse ">
    ...
    <div class="navbar-inner">
        <div class="header-seperation">
            ...
            <!-- BEGIN LOGO -->
            <a href="index.html"><img src="{{ asset('assets/projects/img/logo.png') }}" class="logo" alt=""
                                      data-src="{{ asset('assets/projects/img/logo.png') }}"
                                      data-src-retina="assets/projects/img/logo2x.png" width="106" height="21"/></a>
            <!-- END LOGO -->
            ...
            <div class="pull-right">
                <div class="chat-toggler">
                    ...
                    <div class="profile-pic">
                        <img src="assets/projects/img/profiles/avatar_small.jpg" alt=""
                             data-src="assets/projects/img/profiles/avatar_small.jpg"
                             data-src-retina="assets/projects/img/profiles/avatar_small2x.jpg" width="35" height="35"/>
                    </div>
                </div>
                <ul class="nav quick-section ">
                    <li class="quicklinks">
